        ...
        <ul>
          ...
          <li>
            <p class="text">
              ...
              it refers to SKYWART PRIVATE LIMITED, PLOT NO 4.KHASRA NO:317 S
              TIWARIPUR PARGANA BKTLUCKNOW (UP) that is responsible for your
          ...
          <li>
            <p class="text">
              {" "}
              Country: where Skywart-edu or the owners/founders of Skywart-edu
          ...
          <li>
            <p class="text">
              {" "}
              Customer: refers to the company any organization or person that
              signs up to use the Skywart-edu Service to manage the
          ...
          <li>
            <p class="text">
              ...
              computer or any other device that can be used to visit Skywart-edu
          ...
          <li>
            <p class="text">
              ...
              Skywart-edu or are under contract to perform a service on behalf
          ...
          <li>
            <p class="text">
              {" "}
              Service: refers to the service provided by Skywart-edu as
              described in the relative terms (if available) and on this platfor
            </p>
          </li>
          <li>
            <p class="text">
